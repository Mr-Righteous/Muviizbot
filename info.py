...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001837838782'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Blastwallztv')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = (environ.get("CUSTOM_FILE_CAPTION","𝙵𝙸𝙻𝙴 : {file_name}\n𝚂𝙸𝚉𝙴 : <i>{file_size}</i>\n<b>𝙅𝙊𝙄𝙉 [ⱧɆⱤɆ](https://t.me/blastwallztv)</b>")
