...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>𝙌𝙐𝙀𝙍𝙔: {query}</b> \n‌𝙄𝙈𝘿𝙗 𝘿𝘼𝙏𝘼👇👇:\n🏷 𝙏𝙄𝙏𝙇𝙀: <a href={url}>{title}</a>\n\n🎭 𝙂𝙀𝙉𝙍𝙀: {genres} \n\n📆𝙔𝙀𝘼𝙍: <a href={url}/releaseinfo>{year}</a>\n\n🌟 𝙍𝘼𝙏𝙄𝙉𝙂: <a href={url}/ratings>{rating}</a> / 10")
